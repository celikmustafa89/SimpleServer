...
public final class WebServer {
    ...
    private static String RequestLogFileName;
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileHandler serverLogFH = new FileHandler(ServerLogFileName);
        ...
        FileHandler requestLogFH = new FileHandler(RequestLogFileName);
    ...
    public static void loadProperties() {
        ...
        try {
            ...
            //WebServer class'ı loglarının tutulacağı file adı properties dosyasından alınır.
            ServerLogFileName = prop.getProperty("SERVER_LOG_FILE_NAME");
            //Request class'ı loglarının tutulacağı file adı properties dosyasından alınır.
            RequestLogFileName = prop.getProperty("REQUEST_LOG_FILE_NAME"); 
